...
// Active é o leilão em andamento. Completed é o estado "Closed" (fechado)
// pedido pelo desafio: é para esse status que a rotina de fechamento
// automático atualiza o leilão quando o AUCTION_DURATION expira.
const (
